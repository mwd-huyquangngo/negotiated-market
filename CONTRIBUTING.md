# Contributing to negotiated-market

Love negotiated-market and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/negotiated-market/negotiated-market/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/negotiated-market.git
    # Navigate to the newly cloned directory
    cd negotiated-market
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/negotiated-market/negotiated-market.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/negotiated-market/negotiated-market/blob/master/LICENSE.md).
